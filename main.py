...
from eda import ds_eda_app
from dataprep import ds_dataprep_app
from ml_app import ds_ml_app

home_temp = """
            <div style="background-color:#0e0f3f;padding:1px;border-radius:25px">
		    <h2 style="color:white;font-family:calibri;text-align:center;">MENTAL HEALTH - DATA SCIENCE </h2>
            </div>
            """
home2_temp = """
            <style>
...
desc_about_temp = """
                ...
                <body>
                    ...
                    <ol class="justify-numbering">
                        ...
                        <li>Gender</li>
                        <li>Country</li>
                        <li>State : <i>If you live in the India, which state or territory do you live in?</i></li>
...
def main_section():
    ...
    st.image("mental-health.jpg", use_column_width=False)
    st.sidebar.write('Created by. Akash Kumar')


def main():
    st.set_page_config(page_title="Mental Health Treatment Project", page_icon=":chart_with_upwards_trend:",
                       layout='wide')
    st.sidebar.title("Navigation")
    section = st.sidebar.radio("Go to Menu", (
    "Home", "About Project", "Data Preprocessing & Cleansing", "Exploratory Data Analysis", "Machine Learning"))
